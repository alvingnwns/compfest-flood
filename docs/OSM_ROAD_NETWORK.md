...
- The active flood-risk model is still the explicitly synthetic-label placeholder because Earth Engine authentication blocked C2–C9. OSM provenance does not make the current risk probabilities historical.
